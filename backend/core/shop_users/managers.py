...
class TenantUserManager(UserManager):
    ...
    def create_user(self, username, email=None, password=None, **extra_fields):
        ...
        tenant = extra_fields.get('tenant') or get_current_tenant()
        
        if not tenant and not extra_fields.get('is_superuser', False):
    ...
    def create_superuser(self, username, email=None, password=None, **extra_fields):
        ...
        extra_fields['tenant'] = None  # Superusers don't belong to tenants
